            ...
            <div className="relative bg-gray-900 border border-retro-primary/30 rounded-xl shadow-2xl w-full max-w-md mx-4 overflow-hidden">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-lg font-bold text-white">
                                {isSaveMode ? 'Save Game' : 'Load Game'}
                            </h2>
                            <p className="text-xs text-gray-400">
                                {isSaveMode ? 'Choose a slot to save your progress' : 'Select a save to restore'}
                            </p>
                        </div>
                    </div>
                    <button
                ...
                <div className="p-4 space-y-2 max-h-[400px] overflow-y-auto">
                    {isLoading ? (
                        <div className="flex flex-col items-center justify-center py-12 text-gray-400">
                            ...
                            <span className="text-sm">Loading saves...</span>
                        </div>
                    ) : (
                                        ...
                                        {isAutoSaveSlot ? (
                                            ...
                                            isEmpty ? (
                                                <div className="text-retro-primary/70">
                                                    <p className="font-medium">Auto-Save Slot</p>
                                                    <p className="text-xs text-retro-primary/50">Reserved for automatic saves</p>
                                                </div>
                                            ) : (
                                                <div className="flex items-center gap-3">
                                                    {slotData.screenshot && (
                                            ...
                                            <div className="text-gray-500">
                                                ...
                                                <p className="text-xs">No save data</p>
                                            </div>
                                        ) : (
                                            <div className="flex items-center gap-3">
                                                {/* Screenshot */}
                ...
                <div className="px-6 py-3 bg-black/30 border-t border-white/10">
                    <p className="text-xs text-gray-500 text-center">
                        {isSaveMode
                            ? 'Saves are stored in the cloud and sync across devices'
                            : 'Your progress will be restored to the selected save point'
                        }
                    </p>
                </div>
            </div>
